...
void init_preemption_config(void)
{
    ...
    adc16_set_preempt_queue_enable(BOARD_APP_ADC16_BASE, ADC16_CONFIG_TRG0A, true);
    adc16_set_preempt_queue_enable(BOARD_APP_ADC16_BASE, ADC16_CONFIG_TRG0B, true);
    adc16_set_preempt_queue_enable(BOARD_APP_ADC16_BASE, ADC16_CONFIG_TRG0C, true);

    adc16_set_preempt_queue_enable(BOARD_APP_ADC16_BASE, ADC16_CONFIG_TRG1A, true);
    adc16_set_preempt_queue_enable(BOARD_APP_ADC16_BASE, ADC16_CONFIG_TRG1B, true);
    adc16_set_preempt_queue_enable(BOARD_APP_ADC16_BASE, ADC16_CONFIG_TRG1C, true);
