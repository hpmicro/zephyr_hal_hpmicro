 ...
 */
#define FFA_CTRL_AWQOS_MASK (0x1E0U)
#define FFA_CTRL_AWQOS_SHIFT (5U)
#define FFA_CTRL_AWQOS_SET(x) (((uint32_t)(x) << FFA_CTRL_AWQOS_SHIFT) & FFA_CTRL_AWQOS_MASK)
#define FFA_CTRL_AWQOS_GET(x) (((uint32_t)(x) & FFA_CTRL_AWQOS_MASK) >> FFA_CTRL_AWQOS_SHIFT)
 ...
 */
#define FFA_CTRL_ARQOS_MASK (0x1EU)
#define FFA_CTRL_ARQOS_SHIFT (1U)
#define FFA_CTRL_ARQOS_SET(x) (((uint32_t)(x) << FFA_CTRL_ARQOS_SHIFT) & FFA_CTRL_ARQOS_MASK)
#define FFA_CTRL_ARQOS_GET(x) (((uint32_t)(x) & FFA_CTRL_ARQOS_MASK) >> FFA_CTRL_ARQOS_SHIFT)
