...
/**
 * @brief Get a default configuration for an ADC16 Channel instance.
 * 
 * @param[out] config A pointer to the configuration struct of "adc16_channel_config_t".
 */
void adc16_init_channel_default_config(adc16_channel_config_t *config);
 ...
 *
 * @param[in] ptr An ADC16 peripheral base address.
 * @param[in] config A pointer to the configuration struct of "adc16_channel_config_t".
 ...
 * @retval @ref status_success Get the result of an adc16 conversion in oneshot mode successfully.
 * @retval @ref status_invalid_argument Get the result of an adc16 conversion in oneshot mode unsuccessfully because of passing invalid arguments.
 */
hpm_stat_t adc16_set_preempt_queue_enable(ADC16_Type *ptr, uint8_t trig_ch, bool enable);
 ...
 * @param[out] result The result of an adc16 conversion.
 *
 * @retval @ref status_success Get the result of an adc16 conversion in periodic mode successfully.
 * @retval @ref status_invalid_argument Get the result of an adc16 conversion in periodic mode unsuccessfully because of passing invalid arguments.
 */
